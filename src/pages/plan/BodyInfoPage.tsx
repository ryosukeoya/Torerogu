      ...
      <form onSubmit={handleSubmit(registerBodyInfo)}>
        <div css={templates.contentArea}>
          ...
          <div css={templates.content}>
            <InputForm title={'日付'} type={'isInput'} typeAttr='date' placeholder='60' _css={inputStyle} form={{ name: 'date', option: { required: true } }} />
          </div>
          <div css={templates.content}>
            <InputForm title={'体重'} unit={'kg'} type={'isInput'} typeAttr='text' placeholder='60' _css={inputStyle} form={{ name: 'weight', option: { required: true, maxLength: 3, pattern: /[0-9]/ } }} />
          </div>
        </div>
